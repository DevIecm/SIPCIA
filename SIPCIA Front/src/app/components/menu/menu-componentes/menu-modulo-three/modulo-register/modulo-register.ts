...
@Component({
  ...
  providers: [DatePipe],
  templateUrl: './modulo-register.html',
  styleUrl: './modulo-register.css'
})
export class ModuloRegister implements OnInit{
...
/*
  ...
  getSeccion() {
    this.serviceRegister.getSeccion(
